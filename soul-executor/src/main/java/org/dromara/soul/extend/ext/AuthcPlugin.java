 ...
 */
@Slf4j
public class AuthcPlugin  extends AbstractSoulPlugin {
     ...
     */
    public AuthcPlugin(final ZookeeperCacheManager zookeeperCacheManager) {
    ...
    @Override
    public String named() {
        return PluginEnum.AUTHC.getName();
    }

    @Override
    public int getOrder() {
        return PluginEnum.AUTHC.getCode();
    }
